...
DEFAULT_STAGES = "ingest,validate,detect,resolve,pack,resolve_interval,compare,bench,sensitivity,results,figures,tables"
...
QUICK = {
    "resolve": {
        "level_time_limits": [5, 5, 60, 30, 30, 30, 30],
        "weighted_time_limit": 30,
        "highs_time_limit": 10,
        "lp_time_limit": 10,
        "alt_time_limit": 10,
        "conditional_time_limits": [60, 20, 20, 20],
        "workers": 4,
    },
    "resolve_interval": {
        "level_time_limits": [5, 5, 60, 30, 30, 30, 30],
        ...
        "variant_time_limits": [5, 5, 30, 20, 20, 20, 20],
        "workers": 4,
    },
    "pack": {
        "time_limit": 120,
        "mip_time_limit": 60,
        "lp_time_limit": 60,
        "repack_time_limit": 60,
        "layout_time_limit": 30,
        "workers": 4,
    },
...
def main() -> int:
    ...
    import pipelines.d.stages  # noqa: F401 - registers the stages
