...
\label{tab:q2cancel}
\input{generated/tables/tab_q2_cancelled.tex}
\end{table}
...
\input{generated/tables/tab_q4_model.tex}
\end{minipage}\hfill
\begin{minipage}[t]{0.44\linewidth}
\centering
\caption{问题 4 中被撤销计划的局部环境（列的含义同表~\ref{tab:q2cancel}）。}\label{tab:q4cancel}
\input{generated/tables/tab_q4_cancelled.tex}
\end{minipage}
\end{table}
...
\label{tab:q4schemes}
\input{generated/tables/tab_q4_schemes.tex}
\end{table}
...
\input{generated/tables/tab_bench_scaling.tex}
\end{table}
